...
import static com.example.bank.serializer.StringUtils.EMPTY_STRING;
import static com.example.bank.serializer.StringUtils.NULL_INDEX;
import static com.example.bank.serializer.StringUtils.cutStringFrame;
import static com.example.bank.serializer.StringUtils.indexOfTheN;
import static com.example.bank.serializer.StringUtils.makeStringFrame;
...
public class Serializer {
	...
	private static final char CHAR_REPLACING_SPACE = (char) 67284348;
								...
								field.getType() != String.class ?
									...
									makeStringFrame(
										((String) fieldFromObject)
											...
											.replaceAll(" ", String.valueOf(CHAR_REPLACING_SPACE)),
										'\"'
									)
								);
					} else {
...
//				}
	...
	private Object transformStringValueToObject(String value, Class<?> classOfObject, List<Object> serializedObjects) throws NoSuchFieldException, InvocationTargetException, InstantiationException, IllegalAccessException {
		...
		if(className.equals("boolean")) {
			...
			return insideDeserializing(value, classOfObject, serializedObjects);
		}
